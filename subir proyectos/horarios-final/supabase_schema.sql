...
-- IMPORTANTE: NO incluye tabla usuario (usa auth.users + profiles del equipo 1)
...
-- ============================================================
-- RLS (Row Level Security) — descomentar si Supabase lo exige
-- ============================================================
...
-- Política permisiva para desarrollo (reemplazar en producción):
-- CREATE POLICY "allow_all" ON public.profesor        FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
-- CREATE POLICY "allow_all" ON public.asignatura      FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
-- CREATE POLICY "allow_all" ON public.turno           FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
-- CREATE POLICY "allow_all" ON public.horario_general FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
-- CREATE POLICY "allow_all" ON public.horario_semanal FOR ALL TO anon, authenticated USING (true) WITH CHECK (true);
