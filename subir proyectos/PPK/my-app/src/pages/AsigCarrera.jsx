  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const asignaturasResponse = await axios.get(
            ...
            <div className="header-content">
              ...
              <div>
                ...
                <p className="header-subtitle">
                  {carreraInfo 
                    ? `Plan de estudios de ${carreraInfo.nombre_carrera} (${carreraInfo.años} años)`
          ...
          <div className="info-section">
            ...
            {carreraInfo && (
              <div className="info-item">
                <span className="info-icon">🎓</span>
                <div>
                  <strong>Carrera:</strong> {carreraInfo.nombre_carrera} - {carreraInfo.años} años de duración
                </div>
              </div>
            )}
          </div>
