...
const Notas = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const estudianteResponse = await api.get(
          `/auth/estudiantes/${params.idEstudiante}`
        );
        setEstudianteInfo(estudianteResponse.data[0]);
        
        // Obtener información de la brigada
        const brigadaResponse = await api.get(
          `/auth/brigadas/${params.idBrigada}`
        );
    ...
    const fetchPromedio = async () => {
      try {
        ...
        const response = await api.get(
          `/auth/notas/promedio/promedio/${params.idEstudiante}`
        );
    ...
    const fetchNotas = async () => {
      try {
        ...
        const url = selectedAño
          ? `/auth/notas/estudiante/${params.idEstudiante}/${selectedAño}`
          : `/auth/notas/estudiante/${params.idEstudiante}`;
  ...
  const eliminarNota = async (id, asignatura) => {
    ...
    try {
      await api.delete(`/auth/notas/${id}`);
            ...
            <div className="filtro-año">
              ...
              <div className="select-wrapper">
                ...
                >
                  ...
                  {[...new Set(notas.map(n => n.año))].sort().map((a) => (
                        ...
                        <div className="nota-valor-container">
                          ...
                          <div className="nota-progreso">
                            <div 
                              ...
                              style={{ 
                                width: `${Math.min(100, (parseFloat(n.valor) - 2) / 3 * 100)}%`,
