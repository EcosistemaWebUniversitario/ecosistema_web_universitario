...
const Brigadas = () => {
  ...
  const fetchCarreras = async () => {
    try {
      ...
      const response = await api.get("/auth/carreras");
  ...
  const fetchBrigadas = async () => {
    try {
      ...
      const url = selectedCarrera
        ? `/auth/brigadas/carrera/${selectedCarrera}`
        : "/auth/brigadas";
  ...
  const eliminarBrigada = async () => {
    try {
      await api.delete(`/auth/brigadas/${brigadaToDelete.id_brigada}`);
                    ...
                    <div className="brigada-actions">
                      <button
                        ...
                        onClick={() => {
                          ...
                          navigate(`/home/brigadas/${brigada.id_brigada}/estudiantes`);
                        }}
